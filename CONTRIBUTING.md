...
on PATH — for trying the CLI as installed, without shadowing a system birch anywhere else.

## Repository map

- `crates/` — the Rust workspace:
  - `birch-core` — real tree, sources-as-delta-streams, watcher, git status, search.
