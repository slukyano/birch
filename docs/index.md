...
* [0024 — The event loop draws once per batch, not once per event](adr/0024-the-loop-draws-once-per-batch.md)
* [0025 — A click completes on release, on the row it started on](adr/0025-a-click-completes-on-release.md)
